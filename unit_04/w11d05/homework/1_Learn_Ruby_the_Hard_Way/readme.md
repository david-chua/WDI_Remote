...
3.  What does an exclamation point at the end of a method name usually signify?
  ...
  ```text
    Your answer here: performs a permanent change in the method
  ```

4.  What does a question mark and the end of a method name usually signify?

  ```text
    Your answer here:returns a boolean
  ```
...
8.  If I modify a class in Ruby by adding a method, will instances of that class
  ...
  ```text
    Your answer here: if the instances have already been created, using that method will be able to use the created instance but the output is based on what the method does. 
  ```
