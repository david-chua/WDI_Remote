# ![](https://ga-dash.s3.amazonaws.com/production/assets/logo-9f88ae6c9c3871690e33280fcf557f33.png) Project #4: Building Your Third Full-stack Application

#### Overview

This fourth project is your final foray into **building a full-stack application** in the context of a new Unit. You'll be **building a Rails app,** with an Node/Angular Front-end, which means you'll learn about what it takes to build a single page application, a json api, and the challenge of working in several different languages in one Project.

**This is exciting!** It's a lot, but we've given you the tools over the past few weeks and units to be able build what you need, and you get to decide what you do with it. And you get to be creative in choosing what sort of application you want to build!

**You will be working pairs for this project**, and you'll be designing the app yourself. We hope you'll exercise creativity on this project, sketch some wireframes before you start, and write user stories to define what your users will want to do with the app. Make sure you have time to run these ideas by your instructors to get their feedback before you dive too deep into code! Remember to keep things small and focus on mastering the fundamentals – scope creep/feature creep is the biggest pitfall for any project!
...
* **Utilize an ORM (Active Record) to create a database table structure** and interact with your relationally-stored data
...
* A **working Rails API backend application, built by you**, hosted on Heroku
* A **working Node/Express/Angular frontend application, built by you**, hosted on Heroku
* **Links to your hosted working apps** in the URL section of each GitHub repo
* Two **git repositories hosted on GitHub for frontend and backend**, links to your hosted projects, and frequent commits dating back to the **very beginning** of the project. Commit early, commit often.
...
* **[HTTParty gem to hit API's from your Ruby Backend](https://github.com/jnunemaker/httparty)**
